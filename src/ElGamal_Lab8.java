//Program for the Implementation Of ElGamal Cryptographic  Algorithm

import java.util.*;
import java.math.BigInteger;

public class ElGamal_Lab8 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("Enter the approximate value of the primitive root of  El Gamal key means value of g.");
    ...
    public static BigInteger getGenerator(BigInteger p, Random r) {
        ...
        while (numtries < 1000) {
            ...
            // Weexponentiate our generator until we get 1 mod p.
